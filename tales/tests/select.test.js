...
const GLOBAL_STUBS = require('../_stubs/index')
...
// Simulating shopify data passed into a component ( ./tales/snippets/select.liquid )
const engine = new Liquid({
  root: path.resolve(__dirname, './_snippets_test/'), 
  extname: '.liquid' 
})

// express config
app.engine('liquid', engine.express()); // register liquid engine
app.set('views', path.resolve(__dirname, './_snippets_test/'));            // specify the views directory
app.set('view engine', 'liquid'); 


// stubbed data for the liquid render
const stubbedOptions = require('../_stubs/select.json')
